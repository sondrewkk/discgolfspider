...
class DiscsorSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        if len(products) == 0:
            self.logger.error("No products found for discsor.no")
            return
    ...
    def clean_products(self, products):
        ...
        allowed_product_types = ["Putter", "Midrange", "Fairway driver", "Distance driver"]
    ...
    def create_product_url(self, product_handle: str):
        return f"https://discsor.no/products/{product_handle}"
